function App() {
  return (
    <main className='min-h-screen bg-Yellow grid place-items-center max-lg:px-4'>
      <div className="box p-6 bg-white w-[384px] max-lg:w-full shadow-[8px_8px_0px]  rounded-[20px] border border-black flex flex-col gap-3">
